        ...
        <div ref={dropdownRef} className={style.dropdown}>
            ...
            </div>
            {
                isOpen && (<div className={style.dropdownContent}>
                    <NavLink to="/community/memoForm" onClick={closeDropdown} className={linkClass}>메모폼</NavLink>
                    <NavLink to="/community/memolist" onClick={closeDropdown} className={linkClass}>메모리스트</NavLink>
                    {/* <NavLink to="/hello" onClick={closeDropdown} className={linkClass}>헬로우</NavLink> */}
                    <NavLink to="/community/uplist" onClick={closeDropdown} className={linkClass}>UpboardList</NavLink>
                    <NavLink to="/community/upform" onClick={closeDropdown} className={linkClass}>UpboardForm</NavLink>
                </div>)
            }
        </div>
    )
